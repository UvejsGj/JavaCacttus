...
//        System.out.println("Tekst");
        ...
        System.out.printf("|%10s|%n", "Java");  // min 10 karaktere nese nuk i kemi 10 tekstine shtyn djatht
        System.out.printf("|%10s|%n", "Java i ka 10 karaktere");

        System.out.printf("|%-10s|%n", "Java"); // min 10 karaktere nese nuk i kemi 10 tekstine shtyn majt
        System.out.printf("|%-10s|%n", "Java i ka 10 karaktere");

        // chat => 'c'm string =>"java"

        System.out.printf("Laptop price is: 250.00%s%n", "$");
        System.out.printf("Laptop price is: 250.00%c%n", '$');

        // kombinim i place holderave
        System.out.printf("Une quhem %s %S dhe jam %d vjeqar.%n", "Uvejs", "Gjelaj", 18);

        // Vlera true false => e sakt, falls, true, false
        System.out.printf("A jam student: %b%n", true);
        System.out.printf("A jam student: %B%n", false);

        System.out.printf("Produkti: %s | Sasia: %d | Cmimi: %.2f$%n", "iPhone 17 Pro Max", 1, 1499.9);
